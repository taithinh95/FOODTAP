                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <table class="table table-bordered table-hover dataTable" id="dataTable" width="100%" cellspacing="0" role="grid" aria-describedby="dataTable_info" style="width: 100%;">
                                        <thead>
                                            <tr role="row">
                                                <th class="sorting_asc" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1" style="width: 195px;">Người đăng</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"  style="width: 200px;">Bài đăng</th>
                                                <th class="sorting" tabindex="0" aria-controls="dataTable" rowspan="1" colspan="1"  style="width: 350px;">Nội dụng</th>
                                        ...
                                        <tbody>
                                                ...
                                                <tr role="row" class="odd odd-coupon">
                                                    ...
                                                    <td></td>
                                                    <td class="d-flex">
                                                        <button type="button" class="btn btn-success form-control" style="margin-right: 10px;">Ẩn</button>
                                                    </td>
                                                </tr>

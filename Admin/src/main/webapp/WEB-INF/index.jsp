                        ...
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    ...
                                    <c:forEach var="c" items="${restaurants}">
                                        <c:if test="${c.active==true}">

                                            <c:set var="countres" value="${countres+1}" />
                                        </c:if>

                                    </c:forEach>
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Số cửa hàng </div>

                                    <div class="h5 mb-0 font-weight-bold text-gray-800"> ${countres} </div>
                                ...
                                <div class="col mr-2">
                                    ...
                                    <c:forEach var="item" items="${orders}">
                                        <c:if test="${item.status=='completed'}">
                                            <c:set var="amounts" value="${amounts+item.amount}" />
                                            <c:set var="fees" value="${fee+item.fee}" />
                                        </c:if>

                                    </c:forEach>

                                    <c:set var="totals" value="${amounts*0.2+0.2*(amounts-fees)}"/>

                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Doanh thu</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">${totals} VNĐ</div>
                                </div>
                                <div class="col-auto">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-warning shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">Báo cáo cần xử lý</div>
                                    <c:set var="countReport" value="${0}" />
                                            <c:forEach var="item" items="${reports}">
                                                <c:if test="${item.response==null}">
                                                    <c:set var="countReport" value="${countReport+1}" />
                                                </c:if>

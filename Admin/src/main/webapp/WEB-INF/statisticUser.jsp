...
<div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
        ...
        <!-- End of Topbar -->
        <button class="btn btn-success" onclick="printDiv()" style="float: right;">In thông tin người dùng</button>
        <!-- Begin Page Content -->
        <div class="container-fluid" id="GFG">

            <!-- Page Heading -->
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Người dùng: ${user.fullname}</h1>
                    ...
                    <div class="card border-left-primary shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Lượt theo dõi</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
                                        <c:set var="countFollow" value="${0}" />
                                        <c:forEach var="item" items="${user.followers}">
                                            <c:set var="countFollow" value="${countFollow + 1}" />
                                        </c:forEach>
                                        ${countFollow} lượt
                                    </div>
                                </div>
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-left-success shadow h-100 py-2">
                        <div class="card-body">
                            <div class="row no-gutters align-items-center">
                                <div class="col mr-2">
                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Đơn đã đặt</div>
                                    <div class="h5 mb-0 font-weight-bold text-gray-800">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <form>
                                <div class="form-group">
                                    ...
                                    <input class="form-control" readonly value="${user._id}"/>
                                </div>
                                <div class="form-group">
                                    <label>Tên đầy đủ</label>
                                    <input class="form-control" readonly value="${user.fullname}"/>
                                </div>
                                <div class="form-group">
                ...
                <div class="col-xl-4 col-lg-5">
                    <div class="card shadow mb-4">
                        ...
                        <!-- Card Body -->
                        <div class="card-body">
                            <img style="width: 300px; height: 430px" src="http://localhost:9032/public/image/${user.avatar}"/>
                        </div>
                    </div>
                </div>
            </div>
